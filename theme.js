...
$(document).ready(function () {
    ...
    $(headerI).find('#icon').click(function () {
        ...
        function darkmode(){
            icon.attr('src', '/grossmont/computer-science-and-cybersecurity-organization/media/whitesun.png');
            ...
            $('body').css('background-color', '#8380d0');
        ...
        function lightmode(){
            ...
            $('body').css('background-color', '#89B0E4'); 
